...
let totalDays = +moment().diff(moment(unix), 'days')
...
let avgWeekly = Math.abs(avgDaily * 7 + rent_w + joint_w + phone_w + travel_w + bills_w)

console.log('\n\n')
console.log(`${totalDays} days...`.green)
console.log(`Total spend since ${o[o.length - 1].date}: $${total.toFixed(2)}`.cyan)
